                    ...
                    <table style="width: 650px; margin: 0 auto; margin-bottom: 30px">
                      <tbody>
                        <tr>
                          ...
                          <td style="text-align: right; color:#999"><span>Nero Endüstri Harcırah Formu</span></td>
                        </tr>
                      </tbody>
                    </table>
                  </td>
              ...
              <tbody>
                <tr>
                  <td style="padding: 30px">
                    <h6 style="font-weight: 600">Harcırah Formu Bilgileri</h6>
                    ...
                    <p>
                      <b>Gidiş Tarihi / Ulaşım Tipi: </b>
                      <span><?php echo $gidis_tarihi." / ".$gidis_ulasim_tipi; ?></span>
                    </p>

                    <p>
                      <b>Dönüş Tarihi / Ulaşım Tipi: </b>
