...
<div class="container-fluid">
	<div class="card">
		...
		<div class="card-body">
			<form class="form theme-form" name="tedarikci_talep_olustur" id="tedarikci_talep_olustur">
				<div class="card-body">
					<div class="row">
						<div class="mb-3 row">
				...
				<div class="card-footer text-end">
					<div class="col-md-12">
						<button class="btn btn-primary btn-sm" name="tedarikci_talep_olustur" type="button">Kaydet</button>
					</div>
				</div>
			</form>
		</div>
