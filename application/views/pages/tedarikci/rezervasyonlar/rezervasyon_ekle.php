...
<div class="container-fluid">
	<div class="card">
		...
		<div class="card-body">
			<form class="form theme-form" name="tedarikci_rezervasyon_ekle" id="tedarikci_rezervasyon_ekle">
				<div class="card-body">
					<div class="row">
						...
						<div class="form-group col-md-8">
							<div class="mb-1 row">
								...
								<div class="col-sm-9">
									<input class="form-control"  type="email" name="eposta" placeholder="örn: deneme@hotmail.com" autocomplete="off">
								</div>
							</div>
						</div>
						...
						<div class="form-group col-md-8">
							<div class="mb-1 row">
								...
								<div class="col-sm-9">
									<input class="form-control"  type="text" name="telefon_no" placeholder="örn: 0535 000 00 00" autocomplete="off">
								</div>
							</div>
						</div>
				...
				<div class="card-footer text-end">
					<div class="col-md-12">
						<button class="btn btn-primary btn-sm" name="tedarikci_rezervasyon_ekle" type="button">Kaydet</button>
					</div>
				</div>
			</form>
		</div>
