    ...
    <div class="row">
      <div class="col-sm-6">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Tedarikçi Listesi</li>
        </ol>
      </div>
    </div>
  </div>
            ...
            <table class="display text-center" id="basic-14">
              	...
              	<tbody>
					...
					<tr>
					  ...
					  <td>
						  <div class="media">
							  ...
							  <div class="media-body">
								  <label class="switch">
									  <input type="checkbox" <?php echo $row['onay'] == 1 ? 'checked' : ''; ?> name="tedarikci_durum" value="<?php echo $row['no']; ?>"><span class="switch-state"></span>
								  </label>
							  </div>
					  ...
					  <td>
						<a href="<?php echo base_url(''); ?>admin/tedarikci_duzenle/<?php echo $row['no']; ?>">
