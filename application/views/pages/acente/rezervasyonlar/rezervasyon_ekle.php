...
<div class="container-fluid">
	<div class="card">
		...
		<div class="card-body">
			<form class="form theme-form" name="acente_rezervasyon_ekle" id="acente_rezervasyon_ekle">
				<div class="card-body">
					<div class="row">
				...
				<div class="card-footer text-end">
					<div class="col-md-12">
						<button class="btn btn-primary btn-sm" name="acente_rezervasyon_ekle" type="button">Kaydet</button>
					</div>
				</div>
			</form>
		</div>
